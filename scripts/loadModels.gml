...
d3d_model_floor(global.MODEL[MOD_EFFECT_PLANE],-5,-5,0,5,5,0,1,1);
d3d_model_wall(global.MODEL[MOD_EFFECT_PLANE],-5,0,-5,5,0,5,1,1);
d3d_model_wall(global.MODEL[MOD_EFFECT_PLANE],0,-5,-5,0,5,5,1,1);

/* Load models */
d3d_model_load(global.MODEL[MOD_EFFECT_PLANE_DETAIL],working_directory + "\models\detail_particle.d3d");
